...
const t1 = _createTupleFromIterableObject([1, 2, 3]);

const t2 = _createTupleFromIterableObject([1, _createTupleFromIterableObject([2, 3, _createTupleFromIterableObject([4]), 5]), 6]);
