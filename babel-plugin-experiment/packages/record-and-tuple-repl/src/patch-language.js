...
const tsLanguage = {
	...
	tokenizer: {
		...
		common: [
            ...
            // #{
            [/(#)({)/, [{ token: 'keyword', bracket: "@open" }, { token: "delimiter.curly", bracket: "@open" }]],

            // {| and |}
            [/({)(\|)/, [{ token: 'delimiter.curly', bracket: "@open" }, { token: "keyword", bracket: "@open" }]],
            [/(\|)(})/, [{ token: 'keyword', bracket: "@open" }, { token: "delimiter.curly", bracket: "@close" }]],
            ...
            // #[
            [/(#)(\[)/, [{ token: 'keyword', bracket: "@open" }, { token: "delimiter.square", bracket: "@open" }]],
